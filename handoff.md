...
- `admin.html` / `admin.js`：内容管理后台，支持登录、文章管理、栏目/细分筛选、发布/下架、删除、上传封面、正文富文本编辑、正文插图和账号安全设置。修改密码要求至少 10 位并包含字母和数字，成功后会注销当前设备以外的后台会话。
...
1. 公众号二维码已更新为 `assets/wechat-official-account-qr.jpg`，展示于 `contact.html`。
